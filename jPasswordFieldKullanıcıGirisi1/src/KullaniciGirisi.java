...
public class KullaniciGirisi extends javax.swing.JFrame {
    ...
    private void girisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_girisActionPerformed
        ...
        String message;
        if (kullanici_adi.equals("fturk") && parola.equals("12345")) {
            
            message = "Hoşgeldiniz, " + kullanici_adi;
            
        }
        else if (kullanici_adi.equals("Deha") && parola.equals("12345")) {
            
            message = "Toplar Giremez Git Kendine Sakso Çek " + kullanici_adi;
            
        }
        else if (!kullanici_adi.equals("fturk") && parola.equals("12345")) {
